		...
		<section class="site-cover"  id="section-home">
		  <div class="container">
			<div class="row align-items-center justify-content-center text-center site-vh-100">
			  <div class="col-md-12">
				<h1 class="site-heading site-animate mb-3">Pahala Secangkir Kopi</h1>
			</div>
			</div>
		  </div>
		</section><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/include_front/header.blade.php ENDPATH**/ ?>