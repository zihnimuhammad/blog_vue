...
<html lang="en">
	...
	<body data-spy="scroll" style="height: 100vh;" data-target="#site-navbar" data-offset="200">
		<nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-light site-navbar-light" id="site-navbar">
			<div class="container">
				<a class="navbar-brand" href="/front">
					<img src="<?php echo e(asset('Gambar/logo.png')); ?>" alt="AdminLTE Logo" class="brand-image" style="width: 100px; opacity: 1"></a>
		...
		<?php /**PATH D:\PROJECT\github\blog_vue\resources\views/include_front/header.blade.php ENDPATH**/ ?>