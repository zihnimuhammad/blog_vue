  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Suasana Hati</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/beranda">Home</a></li>
              <li class="breadcrumb-item"><a href="/data-suasanahati">Suasana Hati</a></li>
              <li class="breadcrumb-item active">Tambah Suasana Hati</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
          <form action="<?php echo e(route('simpan-suasanahati')); ?>" method="post">
            <?php echo e(csrf_field()); ?>

              <div class="form-group">
                  <input type="text" id="namaSuasanaHati" name="namaSuasanaHati" class="form-control" placeholder="Nama Suasana Hati">
              </div>
              <div class="form-group">
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Suasanahati/create-suasanahati.blade.php ENDPATH**/ ?>