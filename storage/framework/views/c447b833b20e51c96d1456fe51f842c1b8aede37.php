  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/data-hidanganmenu">Menu Hidangan</a></li>
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
          <form action="<?php echo e(route('simpan-hidanganmenu')); ?>" method="post" enctype="multipart/form-data">
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Hidanganmenu/create-hidanganmenu.blade.php ENDPATH**/ ?>