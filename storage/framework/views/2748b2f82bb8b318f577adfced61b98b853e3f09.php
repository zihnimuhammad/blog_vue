          ...
          <form action="<?php echo e(url('update-pesanan',$dat->id)); ?>" method="post">
            <?php echo e(csrf_field()); ?>
              ...
              <div class="form-group">
                <input type="text" id="idJenisPenyakit" name="idJenisPenyakit" class="form-control" placeholder="ID Jenis Penyakit" value="<?php echo e($dat->idMenu); ?>">
              </div>
              <div class="form-group">
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Datalatih/edit-datalatih.blade.php ENDPATH**/ ?>