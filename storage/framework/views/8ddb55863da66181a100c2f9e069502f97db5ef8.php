      ...
      <div class="card card-info card-outline">
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="<?php echo e(route('create-hidanganmenu')); ?>" class="btn btn-primary">Tambah Data <i class="fas fa-plus-square"></i></a>
          </div>
        </div>
        <div class="card-body">
          <table class="table table-bordered">
            ...
            <?php $__currentLoopData = $hidanganmenu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              ...
              <td>
                <a href="<?php echo e(url('edit-hidanganmenu',$item->id)); ?>"><i class="fas fa-edit"></i></a>
                |
                <a href="<?php echo e(url('delete-hidanganmenu',$item->id)); ?>"><i class="far fa-trash-alt" style="color : red"></i></a>
              </td>
            </tr>
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Hidanganmenu/data-hidanganmenu.blade.php ENDPATH**/ ?>