...
<html lang="en">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        ...
        <!-- text fonts -->
        <link rel="stylesheet" href="<?php echo e(asset('admin/css/ace-fonts.css')); ?>" />

        <!-- ace styles -->
        <link rel="stylesheet" href="<?php echo e(asset('admin/css/ace.css')); ?>" />

        <!--[if lte IE 9]>
                <link rel="stylesheet" href="../assets/css/ace-part2.css') }}" />
        <![endif]-->
        <link rel="stylesheet" href="<?php echo e(asset('admin/css/ace-rtl.css')); ?>" />
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <img src="<?php echo e(asset('Gambar/logo.png')); ?>" alt="AdminLTE Logo" class="brand-image" height="5%" width="50%" alt="" srcset="" style="opacity: 1">
                                ...
                                <div id="login-box" class="login-box visible widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <div class="space-6"></div>
                                           <div class="clearfix"><?php if(Session::has('msgbox')): ?>
											...
											<?php echo csrf_field(); ?>
                                                <fieldset>
                                                    ...
                                                    <div class="clearfix">
														...
														<a href="/front/pages" class="width-35 pull-right btn btn-sm btn-default"> 
...
<?php /**PATH C:\xampp\htdocs\ad\blog_vue\resources\views/login.blade.php ENDPATH**/ ?>