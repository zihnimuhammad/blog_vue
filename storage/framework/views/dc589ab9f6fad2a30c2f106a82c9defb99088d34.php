      ...
      <div class="card card-info card-outline">
        <div class="card-header">
          ...
          <div class="card-tools">
            <a href="<?php echo e(route('create-datalatih')); ?>" class="btn btn-primary">Tambah Data <i class="fas fa-plus-square"></i></a>
          </div>
        </div>
        <div class="card-body">
          <table class="table table-bordered">
            ...
            <tr>
              <td><?php echo e($datalatih->firstItem() + $key); ?></td>
              ...
              <td><?php echo e($item->nilaiBobotLatig); ?></td>
              <td>
                <a href="<?php echo e(url('edit-datalatih',$item->id)); ?>"><i class="fas fa-edit"></i></a>
                <a href="<?php echo e(url('delete-datalatih',$item->id)); ?>"><i class="far fa-trash-alt" style="color : red"></i></a>
              </td>
            </tr>
          ...
          <div class="pull-left">
          Showing
          <?php echo e($datalatih->firstItem()); ?>

          to
          <?php echo e($datalatih->lastItem()); ?>

          of
          <?php echo e($datalatih->total()); ?>

          entries
          </div>
          <div class="pull-right">
            <?php echo e($datalatih->links()); ?>
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Datalatih/data-datalatih.blade.php ENDPATH**/ ?>