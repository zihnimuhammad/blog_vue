  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="/data-makanan">Menu Hidangan</a></li>
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
          <form action="<?php echo e(url('update-hidanganmenu',$hid->id)); ?>" method="post" enctype="multipart/form-data">
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Hidanganmenu/edit-hidanganmenu.blade.php ENDPATH**/ ?>