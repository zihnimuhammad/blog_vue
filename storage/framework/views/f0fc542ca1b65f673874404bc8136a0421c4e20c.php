  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
          <form action="<?php echo e(url('update-suasanahati',$sua->id)); ?>" method="post">
            <?php echo e(csrf_field()); ?>

              <div class="form-group">
                  <input type="text" id="namaSuasanahati" name="namaSuasanahati" class="form-control" placeholder="Nama Suasana Hati" value="<?php echo e($sua->namaSuasanaHati); ?>">
              </div>
              <div class="form-group">
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Suasanahati/edit-suasanahati.blade.php ENDPATH**/ ?>