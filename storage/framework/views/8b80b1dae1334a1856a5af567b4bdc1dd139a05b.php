        ...
        <div class="card-body">
          <form action="<?php echo e(url('update-pesanan',$pes->id)); ?>" method="post">
            <?php echo e(csrf_field()); ?>
              ...
              <div class="form-group">
                <input type="date" id="tanggalPesan" name="tanggalPesan" class="form-control" placeholder="Tanggal Pesanan" value="<?php echo e($pes->tanggalPesan); ?>">
              </div>
              <div class="form-group">
...
</html><?php /**PATH D:\PROJECT\laravel\blog_vue\resources\views/Admin/Pesanan/edit-pesanan.blade.php ENDPATH**/ ?>