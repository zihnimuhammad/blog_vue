  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="card card-info card-outline">
        ...
        <div class="card-body">
          <form class="was-validated" action="<?php echo e(route('simpan-menuhidangan')); ?>" method="post" enctype="multipart/form-data">
...
</html><?php /**PATH D:\PROJECT\github\blog_vue\resources\views/Admin/Menuhidangan/create-menuhidangan.blade.php ENDPATH**/ ?>