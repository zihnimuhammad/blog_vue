          ...
          <div class="col-md-8">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                    <tr>
                      <td><a href="{{asset('AdminLTE/pages/examples/invoice.html')}}">OR9842</a></td>
                    ...
                    <tr>
                      <td><a href="{{asset('AdminLTE/pages/examples/invoice.html')}}">OR1848</a></td>
                    ...
                    <tr>
                      <td><a href="{{asset('AdminLTE/pages/examples/invoice.html')}}">OR7429</a></td>
                      <td>iPhone 6 Plus</td>
              ...
              <div class="card-footer clearfix">
                <a href="{{asset('AdminLTE/javascript:void(0)')}}'" class="btn btn-sm btn-info float-left">Place New Order</a>
                <a href="{{asset('AdminLTE/javascript:void(0)')}}'" class="btn btn-sm btn-secondary float-right">View All Orders</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
