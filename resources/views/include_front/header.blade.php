...
<html lang="en">
    ...
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/open-iconic-bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/animate.css') }}">
    
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/owl.theme.default.min.css') }}">
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/magnific-popup.css') }}">

    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/bootstrap-datepicker.css') }}">
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/jquery.timepicker.css') }}">

    

    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/icomoon.css') }}">
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('front2/eatwell/css/custom.css') }}">
		...
		<nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-light site-navbar-light" id="site-navbar">
			<div class="container">
				<a class="navbar-brand" href="/front">
					<img src="{{asset('Gambar/logo.png')}}" alt="AdminLTE Logo" class="brand-image" style="width: 100px; opacity: 1"></a>
